...
def main(train_path, small_path, eval_path):
    ...
    """
    run_exp(train_path, ks=[3], filename='./output/deg3.png')
    run_exp(train_path, ks=[3, 5, 10, 20], filename='./output/poly.png')
    run_exp(train_path, sine=True, ks=[0, 1, 2, 3, 5, 10, 20], filename='./output/sine.png')
    run_exp(small_path, ks=[1, 2, 5, 10, 20], filename='./output/overfit.png')
