...
def create_dictionary(messages):
    ...
    print(f'The vocabulary size is {len(word_dict.keys())}.')
    return word_dict
    # *** END CODE HERE ***
...
def main():
    ...
    np.savetxt('./output/spam_naive_bayes_predictions', naive_bayes_predictions)
    ...
    print(f'The top 5 indicative words for Naive Bayes are: {top_5_words}')
